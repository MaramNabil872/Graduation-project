...
# Correct the database connection string as per your configuration
app.config['SQLALCHEMY_DATABASE_URI'] = 'mssql+pyodbc://DESKTOP-KMSRDT2\DELL:password@DESKTOP-KMSRDT2\SQLEXPRESS/dishdash?driver=ODBC+Driver+17+for+SQL+Server'
db = SQLAlchemy(app)
