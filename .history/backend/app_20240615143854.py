...
app.config['SQLALCHEMY_DATABASE_URI'] = 'ysql+mysqldb://username:password@localhost/mydatabase'app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)
...
@app.route('/api/register', methods=['POST'])  # Change the method to POST
def register():
    data = request.json
