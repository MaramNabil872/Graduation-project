...
app.config['SQLALCHEMY_DATABASE_URI'] = 'ssql+pyodbc://DESKTOP-KMSRDT2\DELL:<>@DESKTOP-KMSRDT2\SQLEXPRESS/dishdash?driver=ODBC+Driver+17+for+SQL+Server'db = SQLAlchemy(app)
