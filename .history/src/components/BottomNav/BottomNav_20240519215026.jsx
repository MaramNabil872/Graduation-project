  ...
  return (
    <div className="bottom-navbar">
      ...
      <div class="background">
        <img src="maram.jpeg" alt="" width="50%" height="50%" />
        <h1 class="resetPassTxt">Reset Password Successfully !!</h1>
        <button id="Submit" class="submitBTN" type="submit">Log in</button>
      </div>
    </div>
    </div>
  );
