...
function BottomNav() {
  ...
  return (
    <div className="bottom-navbar">
      <a href='/' className={activeButton === 'home' ? 'active' : ''} onClick={() => handleButtonClick('home')}>
        <FaHome className="logo" />
      </button>
      <button className={activeButton === 'comments' ? 'active' : ''} onClick={() => handleButtonClick('comments')}>
      ...
      <button className={activeButton === 'cart' ? 'active' : ''} onClick={() => handleButtonClick('cart')}>
