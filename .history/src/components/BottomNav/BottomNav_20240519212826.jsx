...
import { FaHome, FaChat, FaShoppingBag, FaUser, FaPlus ,FaComments } from 'react-icons/fa';
  ...
  return (
    <div className="bottom-navbar">
      ...
      <div className="container">
        <img src="/pc.png" alt="" />
        <p>
          Your food instantly at your home, faster food tastier food
        </p>
        <button>
          Buy food
        </button>
