...
import StoresPage from './pages/category/StoresPage';
  ...
  <IonApp>
    <IonReactRouter>
      <IonRouterOutlet>
        ...
        <Route exact path="/admin-dashboard" component={ProductsComponent} />
        <Route exact path="/checkout" component={CheckoutPage} />
        <Route exact path="/reset-password" component={ForgetPasswordPage} />
        <Route exact path="/track-order/:orderId" component={OrderTrackPage} />
        <Route path="/categories/:categoryId/stores" component={StoresPage} />
                <Route path="/stores/:storeId/products" component={ProductsPage} />
