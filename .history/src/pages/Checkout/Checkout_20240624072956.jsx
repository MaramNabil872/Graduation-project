...
const CheckoutPage = () => {
    ...
    const [users, setUser] = useState({ address: '' });
    ...
    useEffect(() => {
        ...
        // Fetch user data (this could be from an API or localStorage)
        const storedUser = JSON.parse(localStorage.getItem('user')) || { address: '' };
        setUser(storedUser);
    }, []);
    ...
    const handlePlaceOrder = async () => {
        const orderDetails = {
            ...
            shippingInfo: user.address, // Use the user's address
            ...
            {cart.items.length === 0 ? (
                ...
                <div className="checkout_form">
                    ...
                    <div className="shipping_info">
                        ...
                        <p>Will send to the address: {users.address}</p>
                    </div>
