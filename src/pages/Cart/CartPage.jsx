...
const CartPage = () => {
    ...
    const removeFromCart = (product_id) => {
        const updatedItems = cart.items.filter(item => item.product.product_id !== product_id);
    ...
    const updateCart = (updatedItems) => {
        ...
        const totalPrice = updatedItems.reduce((acc, item) => acc + (item.product.list_price * item.quantity), 0);
